...
class InsuranceType(models.Model):
    ...
    perDayPrice = models.IntegerField(max_length=225)
...
class UploadInsurance(models.Model):
    ...
    insurance_end_date = models.CharField(max_length=150)
    insurer = models.CharField(max_length=225)
    nif = models.IntegerField(max_length=225)
    citizenCardNum = models.IntegerField(max_length=225)
